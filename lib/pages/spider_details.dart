...
class SpiderDetails extends StatelessWidget {
  // final String imgUrl;
  final SpidersController spiderControl = Get.find();
  // final int rank;
  final int index;
  final String imgUrl;
  SpiderDetails({
      ...
      body: Stack(children: [
        ...
        Align(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: FlutterGradients.sunnyMorning(tileMode: TileMode.clamp),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient:
                        FlutterGradients.smartIndigo(tileMode: TileMode.clamp),
                    borderRadius: BorderRadius.only(
